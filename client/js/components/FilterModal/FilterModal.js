...
const FilterModal = ({
  resetFilter, displayFilter, setDisplayFilter, getToggleStores, getToggleStyles, toggleStores, toggleStyles, resetToggle, addfilterStore, addfilterStyle, getfilterStyle, getfilterStore, stores, itemStyles
}) => (
    <Modal
    ...
    >
      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={{ height: '10%', backgroundColor: '#E0D5C4', justifyContent: 'center', alignItems: 'center' }}>
          <TouchableOpacity
